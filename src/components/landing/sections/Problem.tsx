        ...
        <div className="grid grid-cols-1 gap-x-10 gap-y-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3">
            <div className="lg:sticky lg:top-24">
              <Reveal>
                <Kicker tone="dark">03 / The problem</Kicker>
              </Reveal>
              <Reveal delay={80}>
                <p className="mt-5 max-w-[240px] font-mono text-[11px] leading-[1.8] tracking-[0.02em] text-slate-muted">
                  Field notes from 60+ campus hackathons, 2024–2026. Teams rarely fail on
                  ideas. They fail on composition.
                </p>
              </Reveal>
              <Reveal delay={140}>
                <div className="mt-8 space-y-2 border-t border-dark-ink/10 pt-4">
                  {[
                    ["Sample", "n = 412 teams"],
                    ...
                    <div key={k} className="flex justify-between gap-4">
                      <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-slate-tech">
                        {k}
                      </span>
                      <span className="font-mono text-[10px] text-dark-ink">{v}</span>
                    </div>
                  ))}
                </div>
              </Reveal>
          ...
          <div className="lg:col-span-8 lg:col-start-5">
            <Reveal>
              <h2 className="text-[clamp(2rem,4.6vw,3.9rem)] font-medium leading-[1.0] tracking-[-0.04em] text-dark-ink">
            ...
            <Reveal delay={100}>
              <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2">
                <p className="text-[15px] leading-[1.75] text-slate-muted">
                  <span className="float-left mr-2 mt-1 text-[42px] font-medium leading-[0.8] tracking-[-0.04em] text-dark-ink">
                    Y
                  </span>
            ...
            <Reveal delay={160}>
              <figure className="my-14 border-y border-dark-ink/10 py-10">
                <blockquote className="text-[clamp(1.5rem,3vw,2.4rem)] font-medium leading-[1.15] tracking-[-0.035em] text-dark-ink">
                ...
                <figcaption className="mt-6 font-mono text-[10px] uppercase tracking-[0.18em] text-slate-muted">
            ...
            {/* failure ledger */}
            <Reveal>
              <div className="flex items-baseline justify-between border-b border-dark-ink/15 pb-3">
                <Kicker tone="dark">Failure ledger</Kicker>
            ...
            <div className="divide-y divide-dark-ink/10">
              {FAILURES.map((f, i) => (
                <Reveal
                  key={f.t}
                  delay={i * 80}
                  className="group grid grid-cols-12 gap-x-6 gap-y-2 py-6 transition-colors"
                >
                  <div className="col-span-3 md:col-span-2">
                    <span className="font-mono text-[11px] tnum text-amber">{f.t}</span>
                  </div>
                  <div className="col-span-9 md:col-span-4">
                    <h3 className="text-[16px] tracking-[-0.02em] text-dark-ink">
                      {f.title}
                    </h3>
                  </div>
            ...
            <Reveal delay={120}>
              <div className="mt-12 flex items-start gap-4 border-l-2 border-beam bg-paper-3 px-6 py-5">
                <span className="mono-label mt-0.5 text-[#2f6ede]">Constraint</span>
                <p className="text-[14px] leading-[1.7] text-dark-ink/80">
                  Team composition is decided in the first six hours. Any tool that helps
                  has to work <em className="not-italic text-dark-ink">before</em> the
